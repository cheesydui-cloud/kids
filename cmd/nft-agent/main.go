...
import (
	...
	"nft/internal/daemon"
	"nft/internal/daemonclient"
	"nft/internal/nft"
	"nft/internal/sysdeps"
	"nft/internal/tui"
)
...
func runTUI() int {
	...
	if err := client.Health(); err != nil {
		fmt.Fprintln(os.Stderr, "无法连接 nft daemon:", err)
		fmt.Fprintln(os.Stderr, "请先启动 daemon：sudo systemctl start nft-daemon.service")
