...
export function LoginAnnouncementModal() {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-start justify-center bg-black/50 backdrop-blur-[4px] px-4 py-6 overflow-y-auto">
      <div
        className="bg-surface/95 border border-line rounded-[20px] shadow-[0_28px_80px_-24px_rgba(15,23,42,0.55)] w-full max-w-lg my-auto max-h-[calc(100vh-3rem)] flex flex-col animate-in backdrop-blur-xl overflow-hidden"
        role="dialog"
        aria-modal="true"
        aria-label="登录公告"
      >
