  ...
  return (
    <div ref={ref} className="relative">
      <button onClick={() => setOpen(o => !o)}
        ...
        {label}
        {selected.size > 0 && (
          <span className="min-w-[18px] h-[18px] px-1 rounded-full border-[1.5px] border-[color:var(--brand-from)] text-[color:var(--brand-from)] text-[11px] font-bold inline-flex items-center justify-center">
            {selected.size}
          </span>
        )}
