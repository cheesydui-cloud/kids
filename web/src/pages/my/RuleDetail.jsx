  ...
  return (
    <Layout>
      ...
      <div className="flex items-baseline gap-3.5 mb-[22px]">
        <Link to="/my/rules" className="link-accent text-[13px] hover:underline inline-flex items-center gap-1">
      ...
      <div className="card mb-5">
        ...
        <div className="p-5">
          <div className="grid grid-cols-[90px_1fr] gap-4 items-center text-sm">
            ...
            <span className="font-mono text-ink-mut">{fmtBytes(Math.round((rule.exit_bytes || 0) * (user?.billing_rate ?? 1)))}</span>
            {rule.comment && <>
