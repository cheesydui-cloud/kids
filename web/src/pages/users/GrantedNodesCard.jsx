...
function GrantedNodesCard({ userId, nodes, grants, allNodes, allUsers, onDone, embedded = false }) {
    ...
    <div className={shellClass}>
      <div className={embedded ? 'detail-panel-header' : 'card-header'}>
        <div className="min-w-0">
          ...
          {embedded && <div className="detail-panel-sub">{nodes.length} 条线路 · 单点/组合配额</div>}
        </div>
