...
当前版本：**v0.7.10**（下面这条安装命令固定不变，永远装最新版）
...
# 国内机器装国外面板：勾选「国内机器」，从 GitHub 镜像拉二进制（不经过面板下载）
curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/cheesydui-cloud/kids/main/install.sh | bash -s -- agent \
  --gh-proxy https://gh-proxy.com/ \
  --panel-url https://面板域名 \
  --token <hex> \
